...
--
-- Hôte : localhost:3306
-- Généré le :  jeu. 11 oct. 2018 à 07:45
...
('a131', '201810', 0, '0.00', '2018-10-11', 'CL'),
('f4', '201810', 0, '0.00', '2018-10-11', 'CL');
...
(1, 'f4', '201810', 'la chèvre de M. seguain', '2018-09-06', '50.00'),
(2, 'f4', '201810', 'ton père le dauphin', '2018-10-14', '150.00'),
(3, 'a131', '201810', 'Gâteau', '2018-10-14', '200.00');
...
CREATE TABLE `visiteur` (
  ...
  `groupe` varchar(10) NOT NULL DEFAULT 'v'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `visiteur` (`id`, `nom`, `prenom`, `login`, `mdp`, `adresse`, `cp`, `ville`, `dateEmbauche`, `groupe`) VALUES
('a131', 'Villechalane', 'Louis', 'lvillachane', 'jux7g', '8 rue des Charmes', '46000', 'Cahors', '2005-12-21', 'v'),
('a17', 'Andre', 'David', 'dandre', 'oppg5', '1 rue Petit', '46200', 'Lalbenque', '1998-11-23', 'c'),
...
-- Évènements
--
CREATE DEFINER=`root`@`localhost` EVENT `cloture_fiche_frais` ON SCHEDULE EVERY 10 MONTH STARTS '2018-09-10 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE fichefrais SET idEtat = "CL" WHERE idEtat = "CR" AND right(mois, 2) = (SELECT month(adddate(curdate(), INTERVAL -1 MONTH)))$$
